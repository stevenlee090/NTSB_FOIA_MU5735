...
| What happened? | Forensic, evidence-based reading of the final 20 s. Annotated event timeline (fuel cutoff, wheel input, AP disconnect, roll, recovery attempt, impact) plus five hypotheses scored against the FDR signals. |
